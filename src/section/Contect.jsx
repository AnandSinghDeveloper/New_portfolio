    ...
    try {
      await emailjs.send(
        ...
        "template_977au4p",
        {
          ...
          to_email: "anandsingh23112005@gmail.com",
        ...
        <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-green-500/20 rounded-2xl p-8 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 text-lg">
              Thanks for reaching out! I'll get back to you faster than you can
              say "async/await" 😄
            </p>
          </div>
        </div>
            ...
            <div className="relative p-8 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="group">
                  ...
                  >
                    <User
                      className={`inline w-4 h-4 mr-2 transition-all duration-300 ${
                        focusedField === "name"
              ...
              <div className="group">
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <div
                    className={`h-1 bg-gray-700 rounded-full w-24 overflow-hidden ${
                      formData.message.length > 0 ? "animate-pulse" : ""
                    }`}
                  >
                    <div
