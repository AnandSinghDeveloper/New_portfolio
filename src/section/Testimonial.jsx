  ...
  return (
    <figure
      className={twMerge(
        ...
        // Enhanced styling with subtle background
        ...
        "hover:border-indigo-400/60 hover:border-purple-400/60",
        "hover:shadow-lg hover:shadow-indigo-500/10",
        // Dark mode support
        "dark:border-gray-700/30 dark:bg-gradient-to-br dark:from-gray-800/50 dark:via-gray-900/30 dark:to-transparent",
        "dark:hover:border-indigo-400/50 dark:hover:border-purple-400/50"
      )}
    >      
      <div className="relative z-10 flex flex-col items-center gap-3 md:gap-4">
        {/* Image container - no hover effects on image */}
        ...
        {/* Text content with better responsive typography */}
      ...
      {/* Optional body text - uncomment if needed */}
      {body && (
  ...
  return (
    <section className="relative w-full py-8 sm:py-12 md:py-16 lg:py-20">
      ...
      <div className="items-start px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        {/* Marquee container with enhanced gradients */}
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
          ...
          {/* Second row - medium speed, reverse */}
          ...
          {/* Top and bottom gradients for better blending */}
