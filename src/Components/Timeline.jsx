...
export const Timeline = ({ data }) => {
  ...
  return (
    <div className=" section-spacing c-spacing" ref={containerRef}>
      <h2 className=" text-heading"> My Experience Timeline </h2>
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
             <div className=" block md:hidden mb-4 text-2xl font-bold text-neutral-300  text-left ">
              <h3>{item.date}</h3>
              <h3>{item.job}</h3>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-purple-500 via-lavender/45-500 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
